...
num_atom_type = 122  # including the extra motif tokens and graph token +masked tokens
num_chirality_tag = 3  # chirality_tag

num_bond_type = 8  # including aromatic and self-loop edge, and extra motif tokens and graph token +masked tokens
...
class GNNDecoder(torch.nn.Module):
    ...
    def forward(self, x, batch):
        if self._dec_type == "linear":
            ...
            edge_index = batch.edge_index_nosuper
            edge_attr = batch.edge_attr_nosuper
