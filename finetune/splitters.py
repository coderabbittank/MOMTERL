...
def scaffold_split(dataset, smiles_list, task_idx=None, null_value=0,
    ...
    # for scaffold_set in all_scaffold_sets:
    #     smiles_index_collect.extend(scaffold_set)
    #     label_collect.extend([kk]*len(scaffold_set))
    #     kk=kk+1
    #     nums=nums+1
    #     if(nums==7):
    #         break
    ...
    # print(smiles_index_collect)
    # print(label_collect)
    train_dataset = dataset[torch.tensor(train_idx)]
    valid_dataset = dataset[torch.tensor(valid_idx)]
    test_dataset = dataset[torch.tensor(test_idx)]
    # tsne_dataset = dataset[torch.tensor(smiles_index_collect)]
...
if __name__ == "__main__":
    from finetune.loader import MoleculeDataset
