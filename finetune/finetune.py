...
def main():
    ...
    parser.add_argument('--input_model_file', type=str, default = 'saved_model/MOM0.15', help='filename to read the model (if there is any)')
    ...
    parser.add_argument('--UM', type=int, default =0.1, help='um value')
    ...
    if not args.input_model_file == "None":
        ...
        model.from_pretrained('../{}.pth'.format(args.input_model_file))
