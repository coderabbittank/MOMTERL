...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='esol',
                        help='[bbbp, bace, sider, clintox, sider,tox21, toxcast, esol,freesolv,lipophilicity,hiv]')
    ...
    if args.split == "scaffold":
        ...
        train_dataset, valid_dataset, test_dataset, _ = scaffold_split(dataset, smiles_list, null_value=0,
