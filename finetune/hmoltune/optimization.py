...
from finetune.hmoltune.loader import MoleculeDataset
...
from finetune.hmoltune.model import GNN_graphpred
...
def main():
    ...
    parser.add_argument('--input_model_file', type=str,
                        default='../saved_model/model_motif_pretrain_fenhuanbn_simdrop_gin3_300_100epoch.pth',
    ...
    model = GNN_graphpred(args.num_layer, args.emb_dim, num_tasks, logger, JK=args.JK, drop_ratio=args.dropout_ratio,
